...
This repository is a companion to the project report and contains all of the code necessary to reproduce the ReadMe tool as well as report graphs. 
...
the file require the start and end date to be changed in the file. It is a 
...
- `codebase`: module used for all operations of the project
  ...
  - `python files`: organization of functions grouped with related file names
